...
export const zh: Translations = {
  ...
  conductor: {
    ...
    drive: {
      newRun: '新建运行',
      title: '驱动一次指挥',
      intro: '预览指挥计划，然后批准运行。任务将在你的机器上运行。',
      localHint: '在本地运行且免费。不会触发前沿模型。',
      preview: '预览',
      previewing: '正在预览…',
      previewAgain: '重新预览',
      previewError: '无法预览',
      previewErrorDesc: '网关无法生成指挥计划，请重试。',
      noPlan: '尚无计划',
      noPlanDesc: '预览指挥以查看它将运行哪些代理与泳道。',
      planTitle: '计划',
      planReason: '原因',
      agents: '代理',
      noAgents: '此计划中没有代理。',
      laneLabel: lane => `泳道：${lane}`,
      confirmTitle: '所有者批准',
      confirm: '我批准在本地运行此指挥',
      run: '运行',
      running: '正在启动…',
      runError: '无法启动',
      runErrorDesc: '网关无法启动指挥运行，请重试。',
      started: '运行已启动',
      startedDesc: '当收据回传后，任务将很快显示在泳道中。',
