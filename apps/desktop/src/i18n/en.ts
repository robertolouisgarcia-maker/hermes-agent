...
export const en: Translations = {
  ...
  conductor: {
    ...
    drive: {
      newRun: 'New run',
      title: 'Drive a conduct',
      intro: 'Preview the conduct plan, then approve it to run. The mission runs on your machine.',
      localHint: 'Runs locally and free. No frontier model is triggered.',
      preview: 'Preview',
      previewing: 'Previewing...',
      previewAgain: 'Preview again',
      previewError: 'Could not preview',
      previewErrorDesc: 'The gateway could not build the conduct plan. Try again.',
      noPlan: 'No plan yet',
      noPlanDesc: 'Preview the conduct to see which agents and lanes it would run.',
      planTitle: 'Plan',
      planReason: 'Reason',
      agents: 'Agents',
      noAgents: 'No agents in this plan.',
      laneLabel: lane => `Lane: ${lane}`,
      confirmTitle: 'Owner approval',
      confirm: 'I approve running this conduct locally',
      run: 'Run',
      running: 'Starting...',
      runError: 'Could not start',
      runErrorDesc: 'The gateway could not start the conduct run. Try again.',
      started: 'Run started',
      startedDesc: 'The mission will appear in the lanes shortly as its receipt flows back.',
