...
export const ja = defineLocale({
  ...
  conductor: {
    ...
    drive: {
      newRun: '新規実行',
      title: 'コンダクトを実行',
      intro: 'コンダクトの計画をプレビューし、承認して実行します。ミッションはこのマシンで実行されます。',
      localHint: 'ローカルかつ無料で実行されます。フロンティアモデルは起動しません。',
      preview: 'プレビュー',
      previewing: 'プレビュー中…',
      previewAgain: '再プレビュー',
      previewError: 'プレビューできませんでした',
      previewErrorDesc: 'ゲートウェイがコンダクトの計画を作成できませんでした。もう一度お試しください。',
      noPlan: 'まだ計画はありません',
      noPlanDesc: 'コンダクトをプレビューして、どのエージェントとレーンが実行されるか確認してください。',
      planTitle: '計画',
      planReason: '理由',
      agents: 'エージェント',
      noAgents: 'この計画にエージェントはありません。',
      laneLabel: lane => `レーン: ${lane}`,
      confirmTitle: 'オーナーの承認',
      confirm: 'このコンダクトをローカルで実行することを承認します',
      run: '実行',
      running: '開始中…',
      runError: '開始できませんでした',
      runErrorDesc: 'ゲートウェイがコンダクトの実行を開始できませんでした。もう一度お試しください。',
      started: '実行を開始しました',
      startedDesc: 'レシートが返ってくると、まもなくミッションがレーンに表示されます。',
