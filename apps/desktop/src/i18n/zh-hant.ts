...
export const zhHant = defineLocale({
  ...
  conductor: {
    ...
    drive: {
      newRun: '新增執行',
      title: '驅動一次指揮',
      intro: '預覽指揮計畫，然後核准執行。任務將在你的機器上執行。',
      localHint: '在本機執行且免費。不會觸發前沿模型。',
      preview: '預覽',
      previewing: '正在預覽…',
      previewAgain: '重新預覽',
      previewError: '無法預覽',
      previewErrorDesc: '閘道無法產生指揮計畫，請重試。',
      noPlan: '尚無計畫',
      noPlanDesc: '預覽指揮以查看它將執行哪些代理與泳道。',
      planTitle: '計畫',
      planReason: '原因',
      agents: '代理',
      noAgents: '此計畫中沒有代理。',
      ...
      running: '正在啟動…',
      runError: '無法啟動',
      runErrorDesc: '閘道無法啟動指揮執行，請重試。',
      started: '執行已啟動',
      startedDesc: '當收據回傳後，任務將很快顯示在泳道中。',
